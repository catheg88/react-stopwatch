...
function (_React$Component2) {
  ...
  function StartButton(props) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(StartButton).call(this, props));
  ...
  _createClass(StartButton, [{
    ...
    key: "render",
    value: function render() {
      var buttonName = this.props.running ? "Lap" : "Start";
...
function (_React$Component3) {
  ...
  function StopButton(props) {
    ...
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(StopButton).call(this, props));
  ...
  _createClass(StopButton, [{
    ...
    key: "render",
    value: function render() {
      var buttonName = this.props.running ? "Stop" : "Reset";
      return React.createElement("button", {
        className: "button",
        type: "button",
        onClick: this.handleClick
...
function (_React$Component4) {
  _inherits(LapDisplay, _React$Component4);

  function LapDisplay() {
    _classCallCheck(this, LapDisplay);

    return _possibleConstructorReturn(this, _getPrototypeOf(LapDisplay).apply(this, arguments));
  }

  _createClass(LapDisplay, [{
    key: "render",
    value: function render() {
      var laps = this.props.laps.map(function (lap, idx) {
        return React.createElement("div", {
          key: idx
        }, lap);
      });
      return React.createElement("div", null, laps);
    }
  }]);
...
function (_React$Component5) {
  ...
  function Stopwatch(props) {
    ...
    _this5 = _possibleConstructorReturn(this, _getPrototypeOf(Stopwatch).call(this, props));
    _this5.handleClickStart = _this5.handleClickStart.bind(_assertThisInitialized(_this5));
    _this5.handleClickStop = _this5.handleClickStop.bind(_assertThisInitialized(_this5));
    _this5.state = {
      running: false,
      timeStart: null,
      timeStop: null,
  ...
  _createClass(Stopwatch, [{
    ...
    value: function handleClickStart() {
      ...
      if (this.state.timeStart && !this.state.running) {
        // restart
        var currentElapsed = this.state.timeStop - this.state.timeStart;
        this.setState({
          timeStart: Date.now() - currentElapsed
        });
      }
    }
  }, {
    ...
    key: "render",
    value: function render() {
      return React.createElement("div", null, React.createElement(Timer, {
      ...
      }), React.createElement(LapDisplay, {
        laps: this.state.lap
      }));
    }
  }]);
